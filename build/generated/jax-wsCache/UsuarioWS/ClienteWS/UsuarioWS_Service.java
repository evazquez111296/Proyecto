 ...
 * 
 */
@WebServiceClient(name = "UsuarioWS", targetNamespace = "http://ws.electroescom.com/", wsdlLocation = "http://localhost:8084/ElectroESCOM_API/UsuarioWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USUARIOWS_QNAME = new QName("http://ws.electroescom.com/", "UsuarioWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/ElectroESCOM_API/UsuarioWS?wsdl");
    ...
    public UsuarioWS getUsuarioWSPort() {
        return super.getPort(new QName("http://ws.electroescom.com/", "UsuarioWSPort"), UsuarioWS.class);
    }
    ...
    public UsuarioWS getUsuarioWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.electroescom.com/", "UsuarioWSPort"), UsuarioWS.class, features);
    }
